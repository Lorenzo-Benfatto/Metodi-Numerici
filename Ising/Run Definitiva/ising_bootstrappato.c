...
void bootstrap(FILE *f){
    ...
    char filemisure[500];
    sprintf(filemisure, "/home/dario/Documents/UNI/Metodi/Modulo1/Ising/Bootstrap/Nlatt=%d/Bootstrappo/Magnetizzazione/resample_binned%.3f.txt", L, beta);
    m=fopen(filemisure,"w");
    control_file(m);
    
    sprintf(filemisure, "/home/dario/Documents/UNI/Metodi/Modulo1/Ising/Bootstrap/Nlatt=%d/Bootstrappo/Energia/resample_binned%.3f.txt", L, beta);
...
int main()
{
    ...
    char directory[500];
    sprintf(directory, "/home/dario/Documents/UNI/Metodi/Modulo1/Ising/Bootstrap/Nlatt=%d/Risultati", L);
    ...
    while( (entry=readdir(folder)) )
    {
        ...
        char path[500];
        sprintf(path, "/home/dario/Documents/UNI/Metodi/Modulo1/Ising/Bootstrap/Nlatt=%d/Risultati/%s", L, entry->d_name); //it modifies each time the name of the file to be created
