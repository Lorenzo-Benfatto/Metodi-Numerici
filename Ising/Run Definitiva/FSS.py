...
for root, dirs, files in os.walk(directory):
    for i in range(len(dirs)):
        ...
        if index !=-1:
            ...
            # assign directory
            directory = fr"/home/dario/Documents/UNI/Metodi/Modulo1/Ising/Bootstrap/Definitivi/Nlatt={Nlatt}/Bootstrappo/Energia"
            ...
            # assign directory
            directory = fr"/home/dario/Documents/UNI/Metodi/Modulo1/Ising/Bootstrap/Definitivi/Nlatt={Nlatt}/Bootstrappo/Magnetizzazione"
           ...
           # binder_err = np.array(binder_err)
            ...
            ssusc=Susc/Nlatt**gamma
            ssusc_err=(Susc_err**2)/Nlatt**gamma
            t=(beta-beta_C)*Nlatt
            
            
            ax_s.errorbar(t, ssusc, ssusc_err, marker ='.', linestyle = '',label=f'Nlatt = {Nlatt}')
            ...
            #riscalo le quantità e bla bla bla come sopra
            ...
            ax_m.errorbar(tm, mmag, err_mmag, linestyle = '', marker ='.',label=f'Nlatt = {Nlatt}')
...
ax_s.title.set_text('Finite Size Scaling per la Suscettività')
ax_s.set_xlabel(r'$\beta-\beta_C$')
ax_s.set_ylabel(r'$\chi/L^{\gamma/\nu}$')
ax_s.grid()
ax_s.minorticks_on()
ax_s.legend()

ax_m.title.set_text('Finite Size Scaling per la Magnetizzazione')
ax_m.set_xlabel(r'$\beta-\beta_C$')
ax_m.set_ylabel(r'$M/L^{-\beta/\nu}$')
ax_m.grid()            
ax_m.minorticks_on()
ax_m.legend()
plt.show()