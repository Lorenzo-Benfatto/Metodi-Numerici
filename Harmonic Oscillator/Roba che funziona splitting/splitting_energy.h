...
int * measure(float eta, FILE* campo1, FILE* campo2){
...
void Harmonic_metropolis(float y, float primovalore){
    ...
    float eta;
    input = fopen("/Users/margherita/Desktop/UNIPI/QUINT_ANNO/OscillatoreArmonico/Splitting/input_split.txt","r");
    //printf("1\n");
    ...
    FILE* campo2;
    char filename[700];
    sprintf(filename, "/Users/margherita/Desktop/UNIPI/QUINT_ANNO/OscillatoreArmonico/Splitting/Campo/Valoricampo(Eta=%.3f)(NEta=%.0f).txt", eta, primovalore);
    campo1=fopen(filename,"w");
    control_file(campo1);
    char filenome[700];
    sprintf(filenome, "/Users/margherita/Desktop/UNIPI/QUINT_ANNO/OscillatoreArmonico/Splitting/Campo/Valoricampo2(Eta=%.3f)(NEta=%.0f).txt", eta, primovalore);
