...
int main(void){
    ...
    char valori[300];
    printf("######################################################## \n");
    printf("Per simulare il limite al continuo (eta variabile, N*eta fisso) digiti 1\n");
    printf("######################################################## \n");
    ...
    if(scelta==1){
        ...
        sprintf(valori,"/home/dario/Documents/UNI/Metodi/Modulo2/Oscillatore/valori_eta.txt");
        f=fopen(valori,"r");
        control_file(f);
