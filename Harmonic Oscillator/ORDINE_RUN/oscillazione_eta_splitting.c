#include"/home/dario/Documents/UNI/Metodi/Modulo2/Oscillatore/splitting_energy.h"
...
int main(void){
	...
	float ennepereta;
	float singoloeta;
	f=fopen("/home/dario/Documents/UNI/Metodi/Modulo2/Oscillatore/valori_split.txt","r");
	control_file(f);
